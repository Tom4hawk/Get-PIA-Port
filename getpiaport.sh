...
port_forward_assignment(){
	...
	json=`curl --silent --data "user=$USER&pass=$PASSWORD&client_id=$client_id&local_ip=$local_ip" -o - 'https://www.privateinternetaccess.com/vpninfo/port_forward_assignment' | head -1 | grep -o '[0-9]*'`
	echo $json
}
